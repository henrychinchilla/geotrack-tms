...
import { CheckCircle2, Navigation, Map as MapIcon } from 'lucide-react';
...
export default function ViajesPage() {
  ...
  useEffect(() => {
    const fetchVisitas = async () => {
      // Traemos las visitas y cruzamos con la tabla customers para obtener lat y lng
  ...
  // Funciones de ruteo universal (Deep Links)
